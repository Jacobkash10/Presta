...
import { reservationSchema } from '@/components/Demander_page/validators/reservation';
...
const page = () => {
  ...
  const createReservation = async (data: Input) => {
    setLoading(true);
    try {
      if (!data.serviceName || !data.date_reservation || !data.hour || !data.address || !data.tel) {
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          {
                              res?.map((item: any) => (
                                  <SelectItem key={item.id} value={item.name_service}>{item?.name_service}</SelectItem>
                              ))
                          }
                        </SelectContent>
                      </Select>
